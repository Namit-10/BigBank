		...
		Statement stmt = null;
				...
				if(enteredPassword.equals(password)) {
					if(amount > 0) {
						...
						int status = BankDao.deposit(accountNo, amount);
						...
						if(status < 0) {
							...
							out.println("<div style='background-color: red; color: white;'><h2>Deposit Failure!</h2></div><br>Update on database didnt apply.");
						}
						else {
							out.println("<div style='background-color: green; color: white; margin-top: 30px; padding: 15px;'><h2>Deposit Success!</h2></div>");
						}
					}
					else {
						out.println("<div style='background-color: red; color: white;'><h2>Deposit Failure!</h2></div><br>Negative Amount entered.<br>Amount entered cannot be negative!");
					}
				}
				else {
					out.println("<div style='background-color: red; color: white;'><h2>Deposit Failure!</h2></div><br>Authentication Failed!<br>Wrong password entered!");
				}
				out.println("</body>\n"
						+ "</html>");
