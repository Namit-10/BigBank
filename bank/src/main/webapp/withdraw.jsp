...
<center>
<form id = 'withdraw_form' action="Withdraw" method="post">
		
		
		<h1 style="color:white;">Withdraw page</h1>
		
		
		<label for="password" style="color: white;">Enter your password </label>
		<input type="password" name="password" style="color: white;" required><br><br>
		
		<label for="password" style="color: white;">Enter the amount </label>
		<span><small style="color: white;">The available balance in the account <%= accountNo %> is </small><bold><%= balance %></bold></span><br>
