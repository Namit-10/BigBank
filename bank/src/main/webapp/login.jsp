...
<div class="toggle-button d-inline-block d-lg-none"><a href="#" class="site-menu-toggle py-5 js-menu-toggle text-black"><span class="icon-menu h3"></span></a></div>
  ...
  <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="username" name="username" placeholder="Enter username" onchange="clearErrorsFunction()" required>
  </div>
  <div class="col-md-12">
    <label for="password" class="form-label">Password</label>
    <input type="password" class="form-control" id="password" name="password" placeholder="Enter password" onchange="clearErrorsFunction()" required>
  </div>
  ...
  <div class="col-md-12">
  	<p>Don't have an account? Create a new one <a href="signup.jsp">here</a> for free!</p>
  </div>
