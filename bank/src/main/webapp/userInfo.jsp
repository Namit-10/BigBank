...
<form id = 'card-application' action="ViewUserInfo" method="post">
		<center>
		<br><br>
		<h1>View user info by Username</h1><br><br><br>
		<p align="center">
		
		<label for="username" style="color:black;">Enter the username </label>
