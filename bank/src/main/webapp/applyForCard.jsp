...
<div class="site-logo">
<a href="login.jsp" class="text-black"><span class="text" style="color:#800080">BIG BANK</span></a>
</div>
<div class="col-12">
...
<li><a href="card.jsp" class="nav-link disabled">Debit Card</a></li>
...
<div class="no-linked-card-message" style="position: absolute; margin-top: 10%; margin-left: 10%; background-color: white; border: 0px; height: 300px; width: 600px; padding: 15px; border-radius: 10px;">
	<h5>No card found linked to this account.<br><br>Would you like to apply for a debit card?</h5><br>
	<h5>If yes, then congrats! We have the best debit card with </h5><h3>0</h3><h5>Annual Maintainance Charges, and amazing deals.</h5>
</div>
<div class = "apply-for-card-info-box" style="position: absolute; margin-top: 10%; margin-left: 50%; border: 0; background-color: white; height: 300px; width: 600px; padding 50px; border-radius: 15px;">
<form id = 'card-application' action="ApplyForCard" method="post">
		<center>

		<h1 style="margin-top: 35px;">Card Application</h1><br>
		<p align="center">
		...
		<input type="password" name="password"><br><br>
			...
			<button type="submit" style="margin-top: 40px; padding: 10px; background-color: black; color:white; border: 0px; "class="btn d-grid col-11 mx-auto">Apply For Debit Card</button>
