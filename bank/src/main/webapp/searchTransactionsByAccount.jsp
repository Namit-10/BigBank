...
<div class = "user-info-box" style="margin-top:10%;margin-left:35%;width:600px;height:350px;position:absolute;background-color:white;border-radius: 10px; border: 0px;">
<form id = 'card-application' action="showSpecificTransactions.jsp" method="post">
		<center>
		<br><br>
		<h1>Search Transaction by Account Name</h1><br><br><br>
		<p align="center">
		
		<label for="accountNo" style="color:black;">Enter the Account No </label>
		<input type="text" name="accountNo"><br><br>

			<button type="submit" style="margin-top: 40px; color: white; padding: 10px; background-color: #000000; border: 0px; "class="btn d-grid col-11 mx-auto">View Information</button>
