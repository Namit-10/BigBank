...
<center>
<form id = 'withdraw_form' action="Transfer" method="post">
		
		
		<h1 style="color:white;">Transfer page</h1>
		
		
		<label for="password">Enter your password </label>
		<input type="password" name="password" required><br><br>
		
		<label for="receiverAccountNo">Enter receiver Account No.</label>
		<input type="text" name="receiverAccountNo" required><br><br>
		
		<label for="password">Enter the amount </label>
		<span><small>The available balance in your account <%= accountNo %> is </small><bold><%= balance %></bold></span><br>
		<input type = "number" name="amount" min=0 max=<%= balanceInt %> required><br><br>
