...
<div style="margin-top:10%; background-color: red; color: white; width: 100%;"><h1 >Card Application Failed! Wrong password given</h1><br>Click <a href="applyForCard.jsp">here</a> to try again</div>
</body>
</html>