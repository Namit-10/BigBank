...
<div><h2 style='color:white; background-color: red; position: absolute; margin-top:100px;'>Card Status Update Failure! </h2><br><br><h4>Click <a href='cardStatus.jsp'>here</a> to try again.</h4></div>
